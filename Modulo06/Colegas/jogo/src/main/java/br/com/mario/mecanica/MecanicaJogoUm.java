 ...
 * MecanicaJogoUm
 */
public class MecanicaJogoUm implements MecanicaDoJogo {
    ...
    public MecanicaJogoUm(int numeroMaximoAcertos, int numeroMaximoErros, int numeroMaximoTentativasPalavra) {
